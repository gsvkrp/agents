"""Tool functions for the LangGraph worked-example agent.
...
the `AGENT_TOOLS` list that `graph.py` passes to `create_react_agent(tools=...)`.
"""
...
# ---------- Tools registered with the graph ---------------------------------

AGENT_TOOLS = [
    tool(list_amenities),
    # TODO: add more wrapped tools.
]
